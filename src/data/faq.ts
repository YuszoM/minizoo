export const faqItems = [
  {
    question: "Czy trzeba rezerwować wizytę z wyprzedzeniem?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Tak, pod warunkiem zgody opiekuna i zgodnie z regulaminem. Nie wszystkie gatunki można głaskać – zawsze słuchamy instrukcji przewodnika, który dba o dobrostan zwierząt.",
  },
  {
    question: "Ile osób może być w jednej grupie?",
    answer:
      "Spotkanie rodzinne to kameralna wizyta dla 2–6 osób. Przyjęcie urodzinowe — do 6 dzieci + opiekunowie.",
  },
  {
  ...
  {
    question: "Czy obiekt jest przystosowany dla wózków inwalidzkich/dziecięcych?",
    answer:
