      ...
      <div className="container-site section-y grid gap-12 lg:grid-cols-[1.2fr_1fr_1fr]">
        <div className="space-y-5">
          ...
          <p className="max-w-sm text-sm leading-relaxed text-paper/75">
            ...
            edukacyjne lekcje biologii dla szkół pod Wrocławiem.
          </p>
          ...
          <div className="flex gap-3 pt-1">
            <a
              ...
              className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-paper transition hover:bg-white/20"
              aria-label="Facebook"
            >
